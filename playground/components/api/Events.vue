<template>
  <ApiTable title="Events" anchor="api-events" :columns="columns" :rows="rows">
    <code>node</code> 均为内部 Node 实例，<code>nodeComponent</code> 为递归节点组件实例。
  </ApiTable>
</template>
